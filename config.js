...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Waseem.Shahzad",
// add your Session Id 
...
STICKER_NAME: process.env.STICKER_NAME || "Waseem Shahzad",
...
OWNER_NAME: process.env.OWNER_NAME || "Waseem Shahzad",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© Waseem Shahzad*",
// add bot owner name    
